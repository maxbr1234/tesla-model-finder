            ...
            if ((interaction.options.getString('interface')) == 'menus') {
                ...
                (interaction.channel).send({
                    ...
                    collector.on('collect', async i => {
                        if ((i.customId) == 'cWuFf-M2V}sj4VG-' && (i.values[0]) == '}L6B=uX,Sb$g!85p') {
                            await i.update({
                                embeds: [{
                        ...
                        if ((i.customId) == 'cWuFf-M2V}sj4VG-' && (i.values[0]) == 'A%dWJdU,3.uP$D,,') {
                            await i.update({
                                embeds: [{
                        ...
                        if ((i.customId) == 'cWuFf-M2V}sj4VG-' && (i.values[0]) == 'zv8dh8}jm?pjP+F>') {
                            await i.update({
                                embeds: [{
                        ...
                        if ((i.customId) == 'cWuFf-M2V}sj4VG-' && (i.values[0]) == 'Y?yRxan!QyY-#m4n') {
                            await i.update({
                                embeds: [{
                        ...
                        if ((i.customId) == 'cWuFf-M2V}sj4VG-' && (i.values[0]) == '-v-g?)§WD}z+Z!Z}') {
                            await i.update({
                                content: String('Use the Select Menu'),
                                components: [(new MessageActionRow()
                                    .addComponents(
